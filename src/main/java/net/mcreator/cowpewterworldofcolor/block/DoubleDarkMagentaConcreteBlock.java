...
public class DoubleDarkMagentaConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_dark_magenta_concrete")
	public static final Block block = null;
	public DoubleDarkMagentaConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 50);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("double_dark_magenta_concrete");
		}
