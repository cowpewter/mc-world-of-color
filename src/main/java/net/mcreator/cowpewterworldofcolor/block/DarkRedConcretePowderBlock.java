...
public class DarkRedConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_red_concrete_powder")
	public static final Block block = null;
	public DarkRedConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 27);
	}
