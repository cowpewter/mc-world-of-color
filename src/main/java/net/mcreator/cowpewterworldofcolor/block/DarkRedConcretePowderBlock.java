...
public class DarkRedConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:dark_red_concrete_powder")
	public static final Block block = null;
	public DarkRedConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 27);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_red_concrete_powder");
		}
