...
public class PastelLimeConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_lime_concrete_powder")
	public static final Block block = null;
	public PastelLimeConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 107);
	}
