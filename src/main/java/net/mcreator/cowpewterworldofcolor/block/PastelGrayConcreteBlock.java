...
public class PastelGrayConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_gray_concrete")
	public static final Block block = null;
	public PastelGrayConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 100);
	}
