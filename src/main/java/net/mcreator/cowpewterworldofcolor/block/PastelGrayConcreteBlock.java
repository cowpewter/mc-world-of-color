...
public class PastelGrayConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:pastel_gray_concrete")
	public static final Block block = null;
	public PastelGrayConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 100);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pastel_gray_concrete");
		}
