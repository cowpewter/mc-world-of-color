...
public class PastelYellowConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:pastel_yellow_concrete_powder")
	public static final Block block = null;
	public PastelYellowConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 119);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("pastel_yellow_concrete_powder");
		}
