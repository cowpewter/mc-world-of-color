...
public class PastelYellowConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_yellow_concrete_powder")
	public static final Block block = null;
	public PastelYellowConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 119);
	}
