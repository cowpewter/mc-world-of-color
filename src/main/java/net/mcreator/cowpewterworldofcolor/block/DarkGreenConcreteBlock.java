...
public class DarkGreenConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:dark_green_concrete")
	public static final Block block = null;
	public DarkGreenConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 12);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_green_concrete");
		}
