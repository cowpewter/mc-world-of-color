...
public class DarkGreenConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_green_concrete")
	public static final Block block = null;
	public DarkGreenConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 12);
	}
