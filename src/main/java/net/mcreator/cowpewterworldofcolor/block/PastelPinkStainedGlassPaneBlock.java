...
public class PastelPinkStainedGlassPaneBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_pink_stained_glass_pane")
	public static final Block block = null;
	public PastelPinkStainedGlassPaneBlock(CowpewterWocModElements instance) {
		super(instance, 837);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("pastel_pink_stained_glass_pane");
		}
		...
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0.960784313725f, 0.635294117647f, 0.733333333333f};
		}
