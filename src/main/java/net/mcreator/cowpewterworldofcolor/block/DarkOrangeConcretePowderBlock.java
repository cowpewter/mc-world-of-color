...
public class DarkOrangeConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_orange_concrete_powder")
	public static final Block block = null;
	public DarkOrangeConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 21);
	}
