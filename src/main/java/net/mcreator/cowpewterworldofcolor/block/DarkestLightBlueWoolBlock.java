...
public class DarkestLightBlueWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_light_blue_wool")
	public static final Block block = null;
	public DarkestLightBlueWoolBlock(CowpewterWocModElements instance) {
		super(instance, 627);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkest_light_blue_wool");
		}
