...
public class DarkLightBlueWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_light_blue_wool")
	public static final Block block = null;
	public DarkLightBlueWoolBlock(CowpewterWocModElements instance) {
		super(instance, 626);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_light_blue_wool");
		}
