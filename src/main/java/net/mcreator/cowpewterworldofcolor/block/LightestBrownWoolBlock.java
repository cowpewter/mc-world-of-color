...
public class LightestBrownWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_brown_wool")
	public static final Block block = null;
	public LightestBrownWoolBlock(CowpewterWocModElements instance) {
		super(instance, 611);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightest_brown_wool");
		}
