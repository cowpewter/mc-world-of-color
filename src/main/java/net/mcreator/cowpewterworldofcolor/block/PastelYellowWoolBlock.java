...
public class PastelYellowWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_yellow_wool")
	public static final Block block = null;
	public PastelYellowWoolBlock(CowpewterWocModElements instance) {
		super(instance, 662);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pastel_yellow_wool");
		}
