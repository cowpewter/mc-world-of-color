...
public class DoubleDarkPinkConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_dark_pink_concrete_powder")
	public static final Block block = null;
	public DoubleDarkPinkConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 53);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("double_dark_pink_concrete_powder");
		}
