...
public class DarkWhiteWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_white_wool")
	public static final Block block = null;
	public DarkWhiteWoolBlock(CowpewterWocModElements instance) {
		super(instance, 658);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_white_wool");
		}
