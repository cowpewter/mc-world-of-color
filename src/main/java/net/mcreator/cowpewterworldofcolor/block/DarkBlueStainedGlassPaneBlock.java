...
public class DarkBlueStainedGlassPaneBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_blue_stained_glass_pane")
	public static final Block block = null;
	public DarkBlueStainedGlassPaneBlock(CowpewterWocModElements instance) {
		super(instance, 725);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_blue_stained_glass_pane");
		}
		...
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0.188235294118f, 0.211764705882f, 0.533333333333f};
		}
