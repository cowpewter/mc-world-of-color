...
public class LightestRedWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_red_wool")
	public static final Block block = null;
	public LightestRedWoolBlock(CowpewterWocModElements instance) {
		super(instance, 657);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightest_red_wool");
		}
