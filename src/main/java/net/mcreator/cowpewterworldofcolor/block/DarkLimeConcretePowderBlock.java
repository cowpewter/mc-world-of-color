...
public class DarkLimeConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_lime_concrete_powder")
	public static final Block block = null;
	public DarkLimeConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 17);
	}
