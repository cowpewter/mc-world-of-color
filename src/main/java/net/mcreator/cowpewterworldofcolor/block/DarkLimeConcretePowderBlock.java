...
public class DarkLimeConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:dark_lime_concrete_powder")
	public static final Block block = null;
	public DarkLimeConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 17);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_lime_concrete_powder");
		}
