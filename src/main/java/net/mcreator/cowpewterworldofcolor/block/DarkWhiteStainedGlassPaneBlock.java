...
public class DarkWhiteStainedGlassPaneBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_white_stained_glass_pane")
	public static final Block block = null;
	public DarkWhiteStainedGlassPaneBlock(CowpewterWocModElements instance) {
		super(instance, 751);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_white_stained_glass_pane");
		}
		...
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0.780392156863f, 0.8f, 0.796078431373f};
		}
