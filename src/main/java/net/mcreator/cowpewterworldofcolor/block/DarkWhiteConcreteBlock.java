...
public class DarkWhiteConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_white_concrete")
	public static final Block block = null;
	public DarkWhiteConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 30);
	}
