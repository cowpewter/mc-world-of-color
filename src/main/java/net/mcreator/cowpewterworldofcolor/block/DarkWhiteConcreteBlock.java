...
public class DarkWhiteConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:dark_white_concrete")
	public static final Block block = null;
	public DarkWhiteConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 30);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_white_concrete");
		}
