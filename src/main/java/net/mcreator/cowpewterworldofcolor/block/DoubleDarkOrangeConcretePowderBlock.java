...
public class DoubleDarkOrangeConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_dark_orange_concrete_powder")
	public static final Block block = null;
	public DoubleDarkOrangeConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 51);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("double_dark_orange_concrete_powder");
		}
