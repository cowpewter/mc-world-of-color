...
public class DarkestBlueStainedGlassPaneBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_blue_stained_glass_pane")
	public static final Block block = null;
	public DarkestBlueStainedGlassPaneBlock(CowpewterWocModElements instance) {
		super(instance, 755);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("darkest_blue_stained_glass_pane");
		}
		...
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0.141176470588f, 0.160784313725f, 0.4f};
		}
