...
public class DarkestMagentaWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_magenta_wool")
	public static final Block block = null;
	public DarkestMagentaWoolBlock(CowpewterWocModElements instance) {
		super(instance, 639);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkest_magenta_wool");
		}
