...
public class PastelPinkConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:pastel_pink_concrete")
	public static final Block block = null;
	public PastelPinkConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 114);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pastel_pink_concrete");
		}
