...
public class PastelPinkConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_pink_concrete")
	public static final Block block = null;
	public PastelPinkConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 114);
	}
