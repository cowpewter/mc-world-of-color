...
public class PastelBlueStainedGlassPaneBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_blue_stained_glass_pane")
	public static final Block block = null;
	public PastelBlueStainedGlassPaneBlock(CowpewterWocModElements instance) {
		super(instance, 817);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("pastel_blue_stained_glass_pane");
		}
		...
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0.388235294118f, 0.411764705882f, 0.733333333333f};
		}
