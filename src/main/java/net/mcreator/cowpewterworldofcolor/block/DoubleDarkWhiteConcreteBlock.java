...
public class DoubleDarkWhiteConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_dark_white_concrete")
	public static final Block block = null;
	public DoubleDarkWhiteConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 60);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("double_dark_white_concrete");
		}
