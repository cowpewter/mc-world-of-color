...
public class DoubleDarkYellowConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_dark_yellow_concrete_powder")
	public static final Block block = null;
	public DoubleDarkYellowConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 61);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("double_dark_yellow_concrete_powder");
		}
