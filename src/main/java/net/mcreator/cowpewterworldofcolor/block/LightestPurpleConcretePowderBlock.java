...
public class LightestPurpleConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:lightest_purple_concrete_powder")
	public static final Block block = null;
	public LightestPurpleConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 194);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("lightest_purple_concrete_powder");
		}
