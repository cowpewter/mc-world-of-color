...
public class LightestPurpleConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_purple_concrete_powder")
	public static final Block block = null;
	public LightestPurpleConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 194);
	}
