...
public class DoubleDarkGrayConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_dark_gray_concrete")
	public static final Block block = null;
	public DoubleDarkGrayConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 40);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("double_dark_gray_concrete");
		}
