...
public class DarkestLightGrayWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_light_gray_wool")
	public static final Block block = null;
	public DarkestLightGrayWoolBlock(CowpewterWocModElements instance) {
		super(instance, 631);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkest_light_gray_wool");
		}
