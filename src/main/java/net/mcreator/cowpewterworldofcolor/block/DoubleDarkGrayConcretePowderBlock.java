...
public class DoubleDarkGrayConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_dark_gray_concrete_powder")
	public static final Block block = null;
	public DoubleDarkGrayConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 39);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("double_dark_gray_concrete_powder");
		}
