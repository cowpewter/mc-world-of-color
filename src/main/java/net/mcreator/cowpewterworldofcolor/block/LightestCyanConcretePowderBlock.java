...
public class LightestCyanConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:lightest_cyan_concrete_powder")
	public static final Block block = null;
	public LightestCyanConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 176);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("lightest_cyan_concrete_powder");
		}
