...
public class DoubleDarkPinkConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_dark_pink_concrete")
	public static final Block block = null;
	public DoubleDarkPinkConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 54);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("double_dark_pink_concrete");
		}
