...
public class LightestLightGrayStainedGlassPaneBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_light_gray_stained_glass_pane")
	public static final Block block = null;
	public LightestLightGrayStainedGlassPaneBlock(CowpewterWocModElements instance) {
		super(instance, 799);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("lightest_light_gray_stained_glass_pane");
		}
