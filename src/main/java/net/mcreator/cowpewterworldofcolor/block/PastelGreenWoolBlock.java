...
public class PastelGreenWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_green_wool")
	public static final Block block = null;
	public PastelGreenWoolBlock(CowpewterWocModElements instance) {
		super(instance, 624);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pastel_green_wool");
		}
