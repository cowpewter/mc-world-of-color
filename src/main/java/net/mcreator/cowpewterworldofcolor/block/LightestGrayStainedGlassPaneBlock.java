...
public class LightestGrayStainedGlassPaneBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_gray_stained_glass_pane")
	public static final Block block = null;
	public LightestGrayStainedGlassPaneBlock(CowpewterWocModElements instance) {
		super(instance, 793);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("lightest_gray_stained_glass_pane");
		}
