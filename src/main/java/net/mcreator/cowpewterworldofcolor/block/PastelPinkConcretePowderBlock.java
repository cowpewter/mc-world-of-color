...
public class PastelPinkConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_pink_concrete_powder")
	public static final Block block = null;
	public PastelPinkConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 113);
	}
