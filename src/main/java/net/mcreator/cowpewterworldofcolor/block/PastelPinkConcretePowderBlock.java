...
public class PastelPinkConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:pastel_pink_concrete_powder")
	public static final Block block = null;
	public PastelPinkConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 113);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("pastel_pink_concrete_powder");
		}
