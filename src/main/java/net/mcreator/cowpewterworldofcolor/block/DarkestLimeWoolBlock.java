...
public class DarkestLimeWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_lime_wool")
	public static final Block block = null;
	public DarkestLimeWoolBlock(CowpewterWocModElements instance) {
		super(instance, 635);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkest_lime_wool");
		}
