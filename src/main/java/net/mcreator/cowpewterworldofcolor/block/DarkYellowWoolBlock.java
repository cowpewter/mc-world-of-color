...
public class DarkYellowWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_yellow_wool")
	public static final Block block = null;
	public DarkYellowWoolBlock(CowpewterWocModElements instance) {
		super(instance, 660);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_yellow_wool");
		}
