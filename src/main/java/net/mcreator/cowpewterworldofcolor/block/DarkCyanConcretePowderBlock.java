...
public class DarkCyanConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_cyan_concrete_powder")
	public static final Block block = null;
	public DarkCyanConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 7);
	}
