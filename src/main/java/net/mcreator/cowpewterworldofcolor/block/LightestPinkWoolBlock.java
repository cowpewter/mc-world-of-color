...
public class LightestPinkWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_pink_wool")
	public static final Block block = null;
	public LightestPinkWoolBlock(CowpewterWocModElements instance) {
		super(instance, 649);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightest_pink_wool");
		}
