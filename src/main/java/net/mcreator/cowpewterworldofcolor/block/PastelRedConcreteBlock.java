...
public class PastelRedConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:pastel_red_concrete")
	public static final Block block = null;
	public PastelRedConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 118);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pastel_red_concrete");
		}
