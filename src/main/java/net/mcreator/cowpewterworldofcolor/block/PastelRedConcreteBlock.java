...
public class PastelRedConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_red_concrete")
	public static final Block block = null;
	public PastelRedConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 118);
	}
