...
public class PastelLimeStainedGlassPaneBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_lime_stained_glass_pane")
	public static final Block block = null;
	public PastelLimeStainedGlassPaneBlock(CowpewterWocModElements instance) {
		super(instance, 831);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("pastel_lime_stained_glass_pane");
		}
		...
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0.6f, 0.823529411765f, 0.298039215686f};
		}
