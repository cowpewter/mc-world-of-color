...
public class DarkestRedConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_red_concrete_powder")
	public static final Block block = null;
	public DarkestRedConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 164);
	}
