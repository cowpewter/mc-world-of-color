...
public class PastelOrangeConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:pastel_orange_concrete_powder")
	public static final Block block = null;
	public PastelOrangeConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 111);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("pastel_orange_concrete_powder");
		}
