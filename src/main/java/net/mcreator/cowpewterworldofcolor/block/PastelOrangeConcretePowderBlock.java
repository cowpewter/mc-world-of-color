...
public class PastelOrangeConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_orange_concrete_powder")
	public static final Block block = null;
	public PastelOrangeConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 111);
	}
