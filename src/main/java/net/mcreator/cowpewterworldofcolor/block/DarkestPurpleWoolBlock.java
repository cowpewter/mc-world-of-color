...
public class DarkestPurpleWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_purple_wool")
	public static final Block block = null;
	public DarkestPurpleWoolBlock(CowpewterWocModElements instance) {
		super(instance, 651);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkest_purple_wool");
		}
