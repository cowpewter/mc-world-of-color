...
public class DarkestGrayConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:darkest_gray_concrete_powder")
	public static final Block block = null;
	public DarkestGrayConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 146);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("darkest_gray_concrete_powder");
		}
