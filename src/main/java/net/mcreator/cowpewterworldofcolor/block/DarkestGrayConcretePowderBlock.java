...
public class DarkestGrayConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_gray_concrete_powder")
	public static final Block block = null;
	public DarkestGrayConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 146);
	}
