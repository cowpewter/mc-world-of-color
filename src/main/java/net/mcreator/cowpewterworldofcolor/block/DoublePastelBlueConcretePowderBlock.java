...
public class DoublePastelBlueConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_pastel_blue_concrete_powder")
	public static final Block block = null;
	public DoublePastelBlueConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 65);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("double_pastel_blue_concrete_powder");
		}
