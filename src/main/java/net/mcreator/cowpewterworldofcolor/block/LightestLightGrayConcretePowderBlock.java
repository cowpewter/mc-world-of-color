...
public class LightestLightGrayConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_light_gray_concrete_powder")
	public static final Block block = null;
	public LightestLightGrayConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 184);
	}
