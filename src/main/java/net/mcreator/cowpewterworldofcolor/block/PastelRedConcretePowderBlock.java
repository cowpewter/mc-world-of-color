...
public class PastelRedConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_red_concrete_powder")
	public static final Block block = null;
	public PastelRedConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 117);
	}
