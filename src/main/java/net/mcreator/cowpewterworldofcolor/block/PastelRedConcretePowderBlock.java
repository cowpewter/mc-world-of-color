...
public class PastelRedConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:pastel_red_concrete_powder")
	public static final Block block = null;
	public PastelRedConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 117);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("pastel_red_concrete_powder");
		}
