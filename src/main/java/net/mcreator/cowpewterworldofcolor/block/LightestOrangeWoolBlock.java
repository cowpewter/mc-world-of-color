...
public class LightestOrangeWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_orange_wool")
	public static final Block block = null;
	public LightestOrangeWoolBlock(CowpewterWocModElements instance) {
		super(instance, 645);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightest_orange_wool");
		}
