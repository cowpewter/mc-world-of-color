...
public class LightestPurpleWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_purple_wool")
	public static final Block block = null;
	public LightestPurpleWoolBlock(CowpewterWocModElements instance) {
		super(instance, 653);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightest_purple_wool");
		}
