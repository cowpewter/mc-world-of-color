...
public class LightestYellowConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:lightest_yellow_concrete_powder")
	public static final Block block = null;
	public LightestYellowConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 198);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("lightest_yellow_concrete_powder");
		}
