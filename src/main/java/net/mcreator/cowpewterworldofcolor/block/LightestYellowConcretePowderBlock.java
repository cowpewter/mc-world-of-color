...
public class LightestYellowConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_yellow_concrete_powder")
	public static final Block block = null;
	public LightestYellowConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 198);
	}
