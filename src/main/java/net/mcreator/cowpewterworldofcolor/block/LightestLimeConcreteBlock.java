...
public class LightestLimeConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:lightest_lime_concrete")
	public static final Block block = null;
	public LightestLimeConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 185);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightest_lime_concrete");
		}
