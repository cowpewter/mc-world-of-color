...
public class LightestLimeConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_lime_concrete")
	public static final Block block = null;
	public LightestLimeConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 185);
	}
