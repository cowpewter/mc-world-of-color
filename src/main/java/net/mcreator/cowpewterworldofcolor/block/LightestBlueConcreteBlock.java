...
public class LightestBlueConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:lightest_blue_concrete")
	public static final Block block = null;
	public LightestBlueConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 171);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightest_blue_concrete");
		}
