...
public class LightestBlueConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_blue_concrete")
	public static final Block block = null;
	public LightestBlueConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 171);
	}
