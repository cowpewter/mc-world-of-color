...
public class DarkGreenWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_green_wool")
	public static final Block block = null;
	public DarkGreenWoolBlock(CowpewterWocModElements instance) {
		super(instance, 622);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_green_wool");
		}
