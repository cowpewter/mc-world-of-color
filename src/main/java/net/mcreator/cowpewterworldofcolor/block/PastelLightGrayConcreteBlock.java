...
public class PastelLightGrayConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:pastel_light_gray_concrete")
	public static final Block block = null;
	public PastelLightGrayConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 106);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pastel_light_gray_concrete");
		}
