...
public class PastelLightGrayConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_light_gray_concrete")
	public static final Block block = null;
	public PastelLightGrayConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 106);
	}
