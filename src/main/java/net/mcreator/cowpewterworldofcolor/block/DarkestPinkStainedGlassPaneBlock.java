...
public class DarkestPinkStainedGlassPaneBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_pink_stained_glass_pane")
	public static final Block block = null;
	public DarkestPinkStainedGlassPaneBlock(CowpewterWocModElements instance) {
		super(instance, 775);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("darkest_pink_stained_glass_pane");
		}
		...
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0.572549019608f, 0.325490196078f, 0.4f};
		}
