...
public class DarkRedConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_red_concrete")
	public static final Block block = null;
	public DarkRedConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 28);
	}
