...
public class DarkRedConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:dark_red_concrete")
	public static final Block block = null;
	public DarkRedConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 28);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_red_concrete");
		}
