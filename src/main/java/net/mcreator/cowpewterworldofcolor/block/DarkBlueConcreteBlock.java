...
public class DarkBlueConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_blue_concrete")
	public static final Block block = null;
	public DarkBlueConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 4);
	}
