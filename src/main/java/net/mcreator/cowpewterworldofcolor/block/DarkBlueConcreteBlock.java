...
public class DarkBlueConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:dark_blue_concrete")
	public static final Block block = null;
	public DarkBlueConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_blue_concrete");
		}
