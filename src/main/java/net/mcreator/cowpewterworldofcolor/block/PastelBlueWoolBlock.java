...
public class PastelBlueWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_blue_wool")
	public static final Block block = null;
	public PastelBlueWoolBlock(CowpewterWocModElements instance) {
		super(instance, 606);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pastel_blue_wool");
		}
