...
public class LightestPinkConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_pink_concrete")
	public static final Block block = null;
	public LightestPinkConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 191);
	}
