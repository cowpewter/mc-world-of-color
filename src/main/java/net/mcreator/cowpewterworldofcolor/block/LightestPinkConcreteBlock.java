...
public class LightestPinkConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:lightest_pink_concrete")
	public static final Block block = null;
	public LightestPinkConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 191);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightest_pink_concrete");
		}
