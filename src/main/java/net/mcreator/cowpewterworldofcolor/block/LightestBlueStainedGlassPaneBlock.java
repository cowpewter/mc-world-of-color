...
public class LightestBlueStainedGlassPaneBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_blue_stained_glass_pane")
	public static final Block block = null;
	public LightestBlueStainedGlassPaneBlock(CowpewterWocModElements instance) {
		super(instance, 787);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("lightest_blue_stained_glass_pane");
		}
		...
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0.541176470588f, 0.560784313725f, 0.8f};
		}
