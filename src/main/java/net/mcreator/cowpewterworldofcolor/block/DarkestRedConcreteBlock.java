...
public class DarkestRedConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:darkest_red_concrete")
	public static final Block block = null;
	public DarkestRedConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 163);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkest_red_concrete");
		}
