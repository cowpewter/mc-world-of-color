...
public class DarkestRedConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_red_concrete")
	public static final Block block = null;
	public DarkestRedConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 163);
	}
