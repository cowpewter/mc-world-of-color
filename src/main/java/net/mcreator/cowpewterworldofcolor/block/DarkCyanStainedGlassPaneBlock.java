...
public class DarkCyanStainedGlassPaneBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_cyan_stained_glass_pane")
	public static final Block block = null;
	public DarkCyanStainedGlassPaneBlock(CowpewterWocModElements instance) {
		super(instance, 729);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_cyan_stained_glass_pane");
		}
		...
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0.070588235294f, 0.490196078431f, 0.490196078431f};
		}
