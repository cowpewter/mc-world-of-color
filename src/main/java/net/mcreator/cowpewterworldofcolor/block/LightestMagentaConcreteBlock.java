...
public class LightestMagentaConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_magenta_concrete")
	public static final Block block = null;
	public LightestMagentaConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 187);
	}
