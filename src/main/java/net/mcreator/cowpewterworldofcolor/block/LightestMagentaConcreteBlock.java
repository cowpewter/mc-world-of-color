...
public class LightestMagentaConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:lightest_magenta_concrete")
	public static final Block block = null;
	public LightestMagentaConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 187);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightest_magenta_concrete");
		}
