...
public class DarkestCyanWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_cyan_wool")
	public static final Block block = null;
	public DarkestCyanWoolBlock(CowpewterWocModElements instance) {
		super(instance, 613);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkest_cyan_wool");
		}
