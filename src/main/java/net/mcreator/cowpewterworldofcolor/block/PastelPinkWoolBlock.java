...
public class PastelPinkWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_pink_wool")
	public static final Block block = null;
	public PastelPinkWoolBlock(CowpewterWocModElements instance) {
		super(instance, 648);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pastel_pink_wool");
		}
