...
public class DarkGrayWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_gray_wool")
	public static final Block block = null;
	public DarkGrayWoolBlock(CowpewterWocModElements instance) {
		super(instance, 618);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_gray_wool");
		}
