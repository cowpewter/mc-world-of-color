...
public class DarkLightGrayConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:dark_light_gray_concrete_powder")
	public static final Block block = null;
	public DarkLightGrayConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 15);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_light_gray_concrete_powder");
		}
