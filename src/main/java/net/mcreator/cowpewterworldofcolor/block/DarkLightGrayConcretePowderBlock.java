...
public class DarkLightGrayConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_light_gray_concrete_powder")
	public static final Block block = null;
	public DarkLightGrayConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 15);
	}
