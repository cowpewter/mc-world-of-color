...
public class LightestGrayConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:lightest_gray_concrete_powder")
	public static final Block block = null;
	public LightestGrayConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 178);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("lightest_gray_concrete_powder");
		}
