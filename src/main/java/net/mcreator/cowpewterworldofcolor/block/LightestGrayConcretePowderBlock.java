...
public class LightestGrayConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_gray_concrete_powder")
	public static final Block block = null;
	public LightestGrayConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 178);
	}
