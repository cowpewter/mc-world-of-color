...
public class DoublePastelPinkConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_pastel_pink_concrete")
	public static final Block block = null;
	public DoublePastelPinkConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 85);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("double_pastel_pink_concrete");
		}
