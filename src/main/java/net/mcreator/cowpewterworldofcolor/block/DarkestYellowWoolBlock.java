...
public class DarkestYellowWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_yellow_wool")
	public static final Block block = null;
	public DarkestYellowWoolBlock(CowpewterWocModElements instance) {
		super(instance, 661);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkest_yellow_wool");
		}
