...
public class PastelBrownWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_brown_wool")
	public static final Block block = null;
	public PastelBrownWoolBlock(CowpewterWocModElements instance) {
		super(instance, 617);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pastel_brown_wool");
		}
