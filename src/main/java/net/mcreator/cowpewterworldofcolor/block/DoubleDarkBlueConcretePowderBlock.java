...
public class DoubleDarkBlueConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_dark_blue_concrete_powder")
	public static final Block block = null;
	public DoubleDarkBlueConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 33);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("double_dark_blue_concrete_powder");
		}
