...
public class PastelYellowConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_yellow_concrete")
	public static final Block block = null;
	public PastelYellowConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 120);
	}
