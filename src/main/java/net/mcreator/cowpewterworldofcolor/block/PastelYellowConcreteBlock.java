...
public class PastelYellowConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:pastel_yellow_concrete")
	public static final Block block = null;
	public PastelYellowConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 120);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pastel_yellow_concrete");
		}
