...
public class LightestGrayConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_gray_concrete")
	public static final Block block = null;
	public LightestGrayConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 202);
	}
