...
public class LightestGrayConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:lightest_gray_concrete")
	public static final Block block = null;
	public LightestGrayConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 202);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightest_gray_concrete");
		}
