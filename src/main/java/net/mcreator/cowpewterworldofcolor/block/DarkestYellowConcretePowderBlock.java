...
public class DarkestYellowConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_yellow_concrete_powder")
	public static final Block block = null;
	public DarkestYellowConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 168);
	}
