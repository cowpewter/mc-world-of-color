...
public class DarkestRedWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_red_wool")
	public static final Block block = null;
	public DarkestRedWoolBlock(CowpewterWocModElements instance) {
		super(instance, 655);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkest_red_wool");
		}
