...
public class DarkBlueWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_blue_wool")
	public static final Block block = null;
	public DarkBlueWoolBlock(CowpewterWocModElements instance) {
		super(instance, 604);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_blue_wool");
		}
