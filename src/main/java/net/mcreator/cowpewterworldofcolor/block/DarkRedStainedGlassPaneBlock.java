...
public class DarkRedStainedGlassPaneBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_red_stained_glass_pane")
	public static final Block block = null;
	public DarkRedStainedGlassPaneBlock(CowpewterWocModElements instance) {
		super(instance, 749);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_red_stained_glass_pane");
		}
		...
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0.552941176471f, 0.145098039216f, 0.117647058824f};
		}
