...
public class LightestCyanConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_cyan_concrete")
	public static final Block block = null;
	public LightestCyanConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 175);
	}
