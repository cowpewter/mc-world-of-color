...
public class LightestCyanConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:lightest_cyan_concrete")
	public static final Block block = null;
	public LightestCyanConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 175);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightest_cyan_concrete");
		}
