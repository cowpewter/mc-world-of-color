...
public class PastelPurpleWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_purple_wool")
	public static final Block block = null;
	public PastelPurpleWoolBlock(CowpewterWocModElements instance) {
		super(instance, 652);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pastel_purple_wool");
		}
