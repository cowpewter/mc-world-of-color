...
public class PastelLightGrayWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_light_gray_wool")
	public static final Block block = null;
	public PastelLightGrayWoolBlock(CowpewterWocModElements instance) {
		super(instance, 632);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pastel_light_gray_wool");
		}
