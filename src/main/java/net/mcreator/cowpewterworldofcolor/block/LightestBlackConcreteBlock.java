...
public class LightestBlackConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_black_concrete")
	public static final Block block = null;
	public LightestBlackConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 169);
	}
