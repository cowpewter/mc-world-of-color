...
public class LightestBlackConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:lightest_black_concrete")
	public static final Block block = null;
	public LightestBlackConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 169);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightest_black_concrete");
		}
