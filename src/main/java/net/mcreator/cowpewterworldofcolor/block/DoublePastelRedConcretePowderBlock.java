...
public class DoublePastelRedConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_pastel_red_concrete_powder")
	public static final Block block = null;
	public DoublePastelRedConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 89);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("double_pastel_red_concrete_powder");
		}
