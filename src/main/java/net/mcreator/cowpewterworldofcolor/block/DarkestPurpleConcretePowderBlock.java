...
public class DarkestPurpleConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_purple_concrete_powder")
	public static final Block block = null;
	public DarkestPurpleConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 162);
	}
