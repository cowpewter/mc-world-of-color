...
public class DarkestGrayWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_gray_wool")
	public static final Block block = null;
	public DarkestGrayWoolBlock(CowpewterWocModElements instance) {
		super(instance, 619);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkest_gray_wool");
		}
