...
public class DarkestGrayConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:darkest_gray_concrete")
	public static final Block block = null;
	public DarkestGrayConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 145);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkest_gray_concrete");
		}
