...
public class DarkestGrayConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_gray_concrete")
	public static final Block block = null;
	public DarkestGrayConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 145);
	}
