...
public class LightestLightGrayStainedGlassBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_light_gray_stained_glass")
	public static final Block block = null;
	public LightestLightGrayStainedGlassBlock(CowpewterWocModElements instance) {
		super(instance, 798);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightest_light_gray_stained_glass");
		}
