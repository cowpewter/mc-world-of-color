...
public class DarkOrangeWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_orange_wool")
	public static final Block block = null;
	public DarkOrangeWoolBlock(CowpewterWocModElements instance) {
		super(instance, 642);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_orange_wool");
		}
