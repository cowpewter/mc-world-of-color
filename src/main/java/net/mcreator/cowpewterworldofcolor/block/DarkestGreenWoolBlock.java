...
public class DarkestGreenWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_green_wool")
	public static final Block block = null;
	public DarkestGreenWoolBlock(CowpewterWocModElements instance) {
		super(instance, 623);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkest_green_wool");
		}
