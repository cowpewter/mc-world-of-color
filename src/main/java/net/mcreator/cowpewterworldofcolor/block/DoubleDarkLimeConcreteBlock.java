...
public class DoubleDarkLimeConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_dark_lime_concrete")
	public static final Block block = null;
	public DoubleDarkLimeConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 48);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("double_dark_lime_concrete");
		}
