...
public class DarkLightGrayWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_light_gray_wool")
	public static final Block block = null;
	public DarkLightGrayWoolBlock(CowpewterWocModElements instance) {
		super(instance, 630);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_light_gray_wool");
		}
