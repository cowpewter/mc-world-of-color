...
public class PastelPurpleConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:pastel_purple_concrete")
	public static final Block block = null;
	public PastelPurpleConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 116);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pastel_purple_concrete");
		}
