...
public class PastelPurpleConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_purple_concrete")
	public static final Block block = null;
	public PastelPurpleConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 116);
	}
