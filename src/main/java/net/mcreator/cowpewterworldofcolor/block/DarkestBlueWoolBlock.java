...
public class DarkestBlueWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_blue_wool")
	public static final Block block = null;
	public DarkestBlueWoolBlock(CowpewterWocModElements instance) {
		super(instance, 605);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkest_blue_wool");
		}
