...
public class DarkLimeStainedGlassPaneBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_lime_stained_glass_pane")
	public static final Block block = null;
	public DarkLimeStainedGlassPaneBlock(CowpewterWocModElements instance) {
		super(instance, 739);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_lime_stained_glass_pane");
		}
		...
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0.4f, 0.623529411765f, 0.098039215686f};
		}
