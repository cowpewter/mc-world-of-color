...
public class DarkestBrownStainedGlassBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_brown_stained_glass")
	public static final Block block = null;
	public DarkestBrownStainedGlassBlock(CowpewterWocModElements instance) {
		super(instance, 756);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkest_brown_stained_glass");
		}
