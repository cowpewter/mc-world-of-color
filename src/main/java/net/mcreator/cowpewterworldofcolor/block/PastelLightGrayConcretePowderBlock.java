...
public class PastelLightGrayConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:pastel_light_gray_concrete_powder")
	public static final Block block = null;
	public PastelLightGrayConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 105);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("pastel_light_gray_concrete_powder");
		}
