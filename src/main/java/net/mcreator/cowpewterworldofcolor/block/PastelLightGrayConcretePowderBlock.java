...
public class PastelLightGrayConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_light_gray_concrete_powder")
	public static final Block block = null;
	public PastelLightGrayConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 105);
	}
