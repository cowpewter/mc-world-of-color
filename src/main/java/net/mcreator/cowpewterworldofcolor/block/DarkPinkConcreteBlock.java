...
public class DarkPinkConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:dark_pink_concrete")
	public static final Block block = null;
	public DarkPinkConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 24);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_pink_concrete");
		}
