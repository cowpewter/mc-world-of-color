...
public class DarkPinkConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_pink_concrete")
	public static final Block block = null;
	public DarkPinkConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 24);
	}
