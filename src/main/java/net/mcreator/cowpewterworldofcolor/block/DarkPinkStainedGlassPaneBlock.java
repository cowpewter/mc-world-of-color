...
public class DarkPinkStainedGlassPaneBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_pink_stained_glass_pane")
	public static final Block block = null;
	public DarkPinkStainedGlassPaneBlock(CowpewterWocModElements instance) {
		super(instance, 745);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_pink_stained_glass_pane");
		}
		...
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0.760784313725f, 0.435294117647f, 0.533333333333f};
		}
