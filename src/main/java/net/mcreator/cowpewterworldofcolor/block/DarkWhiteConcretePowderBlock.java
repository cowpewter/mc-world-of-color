...
public class DarkWhiteConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_white_concrete_powder")
	public static final Block block = null;
	public DarkWhiteConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 29);
	}
