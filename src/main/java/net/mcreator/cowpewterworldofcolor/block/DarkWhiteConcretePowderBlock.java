...
public class DarkWhiteConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:dark_white_concrete_powder")
	public static final Block block = null;
	public DarkWhiteConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 29);
	}
