...
public class LightestGrayStainedGlassBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_gray_stained_glass")
	public static final Block block = null;
	public LightestGrayStainedGlassBlock(CowpewterWocModElements instance) {
		super(instance, 792);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightest_gray_stained_glass");
		}
