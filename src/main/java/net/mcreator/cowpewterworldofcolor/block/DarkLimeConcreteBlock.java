...
public class DarkLimeConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:dark_lime_concrete")
	public static final Block block = null;
	public DarkLimeConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 18);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_lime_concrete");
		}
