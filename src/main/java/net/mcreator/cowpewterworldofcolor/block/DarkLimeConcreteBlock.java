...
public class DarkLimeConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_lime_concrete")
	public static final Block block = null;
	public DarkLimeConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 18);
	}
