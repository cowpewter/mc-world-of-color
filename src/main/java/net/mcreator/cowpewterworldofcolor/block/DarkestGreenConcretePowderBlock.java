...
public class DarkestGreenConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:darkest_green_concrete_powder")
	public static final Block block = null;
	public DarkestGreenConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 148);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("darkest_green_concrete_powder");
		}
