...
public class DarkestGreenConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_green_concrete_powder")
	public static final Block block = null;
	public DarkestGreenConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 148);
	}
