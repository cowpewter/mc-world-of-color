...
public class DoublePastelGrayConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_pastel_gray_concrete_powder")
	public static final Block block = null;
	public DoublePastelGrayConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 71);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("double_pastel_gray_concrete_powder");
		}
