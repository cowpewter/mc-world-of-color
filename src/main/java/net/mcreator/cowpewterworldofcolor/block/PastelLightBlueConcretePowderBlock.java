...
public class PastelLightBlueConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_light_blue_concrete_powder")
	public static final Block block = null;
	public PastelLightBlueConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 103);
	}
