...
public class PastelLightBlueConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:pastel_light_blue_concrete_powder")
	public static final Block block = null;
	public PastelLightBlueConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 103);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("pastel_light_blue_concrete_powder");
		}
