...
public class DoublePastelGrayConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_pastel_gray_concrete")
	public static final Block block = null;
	public DoublePastelGrayConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 72);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("double_pastel_gray_concrete");
		}
