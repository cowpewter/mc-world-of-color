...
public class DarkPurpleConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:dark_purple_concrete_powder")
	public static final Block block = null;
	public DarkPurpleConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 25);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_purple_concrete_powder");
		}
