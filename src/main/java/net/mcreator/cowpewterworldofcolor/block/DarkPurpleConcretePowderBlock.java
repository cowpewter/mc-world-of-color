...
public class DarkPurpleConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_purple_concrete_powder")
	public static final Block block = null;
	public DarkPurpleConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 25);
	}
