...
public class DarkGreenStainedGlassPaneBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_green_stained_glass_pane")
	public static final Block block = null;
	public DarkGreenStainedGlassPaneBlock(CowpewterWocModElements instance) {
		super(instance, 733);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_green_stained_glass_pane");
		}
		...
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0.294117647059f, 0.388235294118f, 0.070588235294f};
		}
