...
public class LightestLightBlueConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_light_blue_concrete")
	public static final Block block = null;
	public LightestLightBlueConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 181);
	}
