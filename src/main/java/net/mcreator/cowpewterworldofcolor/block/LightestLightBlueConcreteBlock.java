...
public class LightestLightBlueConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:lightest_light_blue_concrete")
	public static final Block block = null;
	public LightestLightBlueConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 181);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightest_light_blue_concrete");
		}
