...
public class DarkGreenConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:dark_green_concrete_powder")
	public static final Block block = null;
	public DarkGreenConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 11);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_green_concrete_powder");
		}
