...
public class DarkGreenConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_green_concrete_powder")
	public static final Block block = null;
	public DarkGreenConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 11);
	}
