...
public class LightestLightBlueWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_light_blue_wool")
	public static final Block block = null;
	public LightestLightBlueWoolBlock(CowpewterWocModElements instance) {
		super(instance, 629);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightest_light_blue_wool");
		}
