...
public class DoubleDarkRedConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_dark_red_concrete")
	public static final Block block = null;
	public DoubleDarkRedConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 58);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("double_dark_red_concrete");
		}
