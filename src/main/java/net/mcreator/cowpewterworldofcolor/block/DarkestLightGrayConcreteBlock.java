...
public class DarkestLightGrayConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_light_gray_concrete")
	public static final Block block = null;
	public DarkestLightGrayConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 151);
	}
