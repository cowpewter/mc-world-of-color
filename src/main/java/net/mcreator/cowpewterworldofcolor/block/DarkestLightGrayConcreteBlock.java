...
public class DarkestLightGrayConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:darkest_light_gray_concrete")
	public static final Block block = null;
	public DarkestLightGrayConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 151);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkest_light_gray_concrete");
		}
