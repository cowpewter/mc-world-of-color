...
public class DarkLightBlueConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:dark_light_blue_concrete_powder")
	public static final Block block = null;
	public DarkLightBlueConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 13);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_light_blue_concrete_powder");
		}
