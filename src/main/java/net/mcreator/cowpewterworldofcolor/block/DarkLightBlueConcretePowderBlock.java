...
public class DarkLightBlueConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_light_blue_concrete_powder")
	public static final Block block = null;
	public DarkLightBlueConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 13);
	}
