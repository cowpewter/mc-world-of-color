...
public class PastelRedWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_red_wool")
	public static final Block block = null;
	public PastelRedWoolBlock(CowpewterWocModElements instance) {
		super(instance, 656);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pastel_red_wool");
		}
