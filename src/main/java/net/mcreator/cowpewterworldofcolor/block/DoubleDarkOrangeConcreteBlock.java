...
public class DoubleDarkOrangeConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_dark_orange_concrete")
	public static final Block block = null;
	public DoubleDarkOrangeConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 52);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("double_dark_orange_concrete");
		}
