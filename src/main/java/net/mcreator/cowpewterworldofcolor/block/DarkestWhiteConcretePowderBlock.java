...
public class DarkestWhiteConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_white_concrete_powder")
	public static final Block block = null;
	public DarkestWhiteConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 166);
	}
