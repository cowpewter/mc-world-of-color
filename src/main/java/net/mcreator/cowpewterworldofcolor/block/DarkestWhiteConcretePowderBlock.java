...
public class DarkestWhiteConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:darkest_white_concrete_powder")
	public static final Block block = null;
	public DarkestWhiteConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 166);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("darkest_white_concrete_powder");
		}
