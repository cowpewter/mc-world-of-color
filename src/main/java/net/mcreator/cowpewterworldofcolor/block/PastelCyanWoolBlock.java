...
public class PastelCyanWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_cyan_wool")
	public static final Block block = null;
	public PastelCyanWoolBlock(CowpewterWocModElements instance) {
		super(instance, 616);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pastel_cyan_wool");
		}
