...
public class DarkestPinkConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:darkest_pink_concrete")
	public static final Block block = null;
	public DarkestPinkConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 159);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkest_pink_concrete");
		}
