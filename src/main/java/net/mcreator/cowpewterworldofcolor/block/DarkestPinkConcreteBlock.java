...
public class DarkestPinkConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_pink_concrete")
	public static final Block block = null;
	public DarkestPinkConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 159);
	}
