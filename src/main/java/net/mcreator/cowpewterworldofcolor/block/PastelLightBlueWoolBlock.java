...
public class PastelLightBlueWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_light_blue_wool")
	public static final Block block = null;
	public PastelLightBlueWoolBlock(CowpewterWocModElements instance) {
		super(instance, 628);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pastel_light_blue_wool");
		}
