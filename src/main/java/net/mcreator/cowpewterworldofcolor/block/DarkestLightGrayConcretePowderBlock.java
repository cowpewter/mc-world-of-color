...
public class DarkestLightGrayConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_light_gray_concrete_powder")
	public static final Block block = null;
	public DarkestLightGrayConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 152);
	}
