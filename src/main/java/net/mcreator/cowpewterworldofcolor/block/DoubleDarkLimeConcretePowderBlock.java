...
public class DoubleDarkLimeConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_dark_lime_concrete_powder")
	public static final Block block = null;
	public DoubleDarkLimeConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 47);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("double_dark_lime_concrete_powder");
		}
