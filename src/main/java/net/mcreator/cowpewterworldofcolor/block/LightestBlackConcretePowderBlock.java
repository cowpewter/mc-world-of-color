...
public class LightestBlackConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_black_concrete_powder")
	public static final Block block = null;
	public LightestBlackConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 200);
	}
