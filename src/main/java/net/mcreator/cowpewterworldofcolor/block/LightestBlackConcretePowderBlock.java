...
public class LightestBlackConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:lightest_black_concrete_powder")
	public static final Block block = null;
	public LightestBlackConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 200);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("lightest_black_concrete_powder");
		}
