...
public class DarkestOrangeConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:darkest_orange_concrete_powder")
	public static final Block block = null;
	public DarkestOrangeConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 158);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("darkest_orange_concrete_powder");
		}
