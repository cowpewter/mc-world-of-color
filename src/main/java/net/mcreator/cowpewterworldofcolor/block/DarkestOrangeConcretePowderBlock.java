...
public class DarkestOrangeConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_orange_concrete_powder")
	public static final Block block = null;
	public DarkestOrangeConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 158);
	}
