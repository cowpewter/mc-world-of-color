...
public class DoubleDarkGreenConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_dark_green_concrete_powder")
	public static final Block block = null;
	public DoubleDarkGreenConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 41);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("double_dark_green_concrete_powder");
		}
