...
public class DarkestMagentaConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:darkest_magenta_concrete")
	public static final Block block = null;
	public DarkestMagentaConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 155);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkest_magenta_concrete");
		}
