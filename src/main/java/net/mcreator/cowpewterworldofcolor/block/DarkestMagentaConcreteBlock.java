...
public class DarkestMagentaConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_magenta_concrete")
	public static final Block block = null;
	public DarkestMagentaConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 155);
	}
