...
public class DarkBrownConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:dark_brown_concrete")
	public static final Block block = null;
	public DarkBrownConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 6);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_brown_concrete");
		}
