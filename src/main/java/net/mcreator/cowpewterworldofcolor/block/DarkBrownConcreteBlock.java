...
public class DarkBrownConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_brown_concrete")
	public static final Block block = null;
	public DarkBrownConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 6);
	}
