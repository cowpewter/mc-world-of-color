...
public class DarkBrownStainedGlassPaneBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_brown_stained_glass_pane")
	public static final Block block = null;
	public DarkBrownStainedGlassPaneBlock(CowpewterWocModElements instance) {
		super(instance, 727);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_brown_stained_glass_pane");
		}
		...
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0.411764705882f, 0.262745098039f, 0.156862745098f};
		}
