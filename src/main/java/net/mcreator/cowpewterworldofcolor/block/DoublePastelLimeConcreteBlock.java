...
public class DoublePastelLimeConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_pastel_lime_concrete")
	public static final Block block = null;
	public DoublePastelLimeConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 80);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("double_pastel_lime_concrete");
		}
