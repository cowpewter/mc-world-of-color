...
public class LightestCyanWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_cyan_wool")
	public static final Block block = null;
	public LightestCyanWoolBlock(CowpewterWocModElements instance) {
		super(instance, 615);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightest_cyan_wool");
		}
