...
public class DoubleDarkBrownConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_dark_brown_concrete")
	public static final Block block = null;
	public DoubleDarkBrownConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 36);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("double_dark_brown_concrete");
		}
