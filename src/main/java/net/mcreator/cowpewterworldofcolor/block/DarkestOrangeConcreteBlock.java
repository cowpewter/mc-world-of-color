...
public class DarkestOrangeConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:darkest_orange_concrete")
	public static final Block block = null;
	public DarkestOrangeConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 157);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkest_orange_concrete");
		}
