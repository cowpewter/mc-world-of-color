...
public class DarkestOrangeConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_orange_concrete")
	public static final Block block = null;
	public DarkestOrangeConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 157);
	}
