...
public class DarkestOrangeWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_orange_wool")
	public static final Block block = null;
	public DarkestOrangeWoolBlock(CowpewterWocModElements instance) {
		super(instance, 643);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkest_orange_wool");
		}
