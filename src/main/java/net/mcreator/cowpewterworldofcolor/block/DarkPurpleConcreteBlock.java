...
public class DarkPurpleConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:dark_purple_concrete")
	public static final Block block = null;
	public DarkPurpleConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_purple_concrete");
		}
