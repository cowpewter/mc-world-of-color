...
public class DarkPurpleConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_purple_concrete")
	public static final Block block = null;
	public DarkPurpleConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 26);
	}
