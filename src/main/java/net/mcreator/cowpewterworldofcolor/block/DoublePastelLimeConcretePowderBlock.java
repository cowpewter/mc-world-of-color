...
public class DoublePastelLimeConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_pastel_lime_concrete_powder")
	public static final Block block = null;
	public DoublePastelLimeConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 79);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("double_pastel_lime_concrete_powder");
		}
