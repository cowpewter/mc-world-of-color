...
public class DoublePastelCyanConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_pastel_cyan_concrete")
	public static final Block block = null;
	public DoublePastelCyanConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 70);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("double_pastel_cyan_concrete");
		}
