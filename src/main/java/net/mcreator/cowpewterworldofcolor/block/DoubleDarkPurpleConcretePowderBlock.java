...
public class DoubleDarkPurpleConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_dark_purple_concrete_powder")
	public static final Block block = null;
	public DoubleDarkPurpleConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 55);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("double_dark_purple_concrete_powder");
		}
