...
public class DoubleDarkBlueConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_dark_blue_concrete")
	public static final Block block = null;
	public DoubleDarkBlueConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 34);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("double_dark_blue_concrete");
		}
