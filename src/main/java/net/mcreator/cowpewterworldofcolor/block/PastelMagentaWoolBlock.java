...
public class PastelMagentaWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_magenta_wool")
	public static final Block block = null;
	public PastelMagentaWoolBlock(CowpewterWocModElements instance) {
		super(instance, 640);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pastel_magenta_wool");
		}
