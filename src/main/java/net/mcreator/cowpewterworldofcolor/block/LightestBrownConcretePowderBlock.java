...
public class LightestBrownConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:lightest_brown_concrete_powder")
	public static final Block block = null;
	public LightestBrownConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 174);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("lightest_brown_concrete_powder");
		}
