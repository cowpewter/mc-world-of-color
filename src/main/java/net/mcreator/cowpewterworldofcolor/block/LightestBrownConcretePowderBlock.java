...
public class LightestBrownConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_brown_concrete_powder")
	public static final Block block = null;
	public LightestBrownConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 174);
	}
