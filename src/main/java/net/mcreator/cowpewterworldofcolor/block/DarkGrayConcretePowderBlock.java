...
public class DarkGrayConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_gray_concrete_powder")
	public static final Block block = null;
	public DarkGrayConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 9);
	}
