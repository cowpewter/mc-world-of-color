...
public class LightestBlueConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_blue_concrete_powder")
	public static final Block block = null;
	public LightestBlueConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 172);
	}
