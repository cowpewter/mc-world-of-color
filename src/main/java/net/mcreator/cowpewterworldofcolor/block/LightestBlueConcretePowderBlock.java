...
public class LightestBlueConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:lightest_blue_concrete_powder")
	public static final Block block = null;
	public LightestBlueConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 172);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("lightest_blue_concrete_powder");
		}
