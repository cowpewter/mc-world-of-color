...
public class DoublePastelRedConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_pastel_red_concrete")
	public static final Block block = null;
	public DoublePastelRedConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 90);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("double_pastel_red_concrete");
		}
