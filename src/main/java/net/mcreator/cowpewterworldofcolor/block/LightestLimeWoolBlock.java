...
public class LightestLimeWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_lime_wool")
	public static final Block block = null;
	public LightestLimeWoolBlock(CowpewterWocModElements instance) {
		super(instance, 637);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightest_lime_wool");
		}
