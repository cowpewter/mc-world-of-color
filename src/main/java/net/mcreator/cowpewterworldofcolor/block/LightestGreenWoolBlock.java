...
public class LightestGreenWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_green_wool")
	public static final Block block = null;
	public LightestGreenWoolBlock(CowpewterWocModElements instance) {
		super(instance, 625);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightest_green_wool");
		}
