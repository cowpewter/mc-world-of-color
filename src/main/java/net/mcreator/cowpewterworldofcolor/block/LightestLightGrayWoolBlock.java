...
public class LightestLightGrayWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_light_gray_wool")
	public static final Block block = null;
	public LightestLightGrayWoolBlock(CowpewterWocModElements instance) {
		super(instance, 633);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightest_light_gray_wool");
		}
