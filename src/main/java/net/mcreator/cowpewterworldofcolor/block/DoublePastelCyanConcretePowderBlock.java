...
public class DoublePastelCyanConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_pastel_cyan_concrete_powder")
	public static final Block block = null;
	public DoublePastelCyanConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 69);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("double_pastel_cyan_concrete_powder");
		}
