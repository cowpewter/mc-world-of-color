...
public class DarkLimeWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_lime_wool")
	public static final Block block = null;
	public DarkLimeWoolBlock(CowpewterWocModElements instance) {
		super(instance, 634);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_lime_wool");
		}
