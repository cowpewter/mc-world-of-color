...
public class DarkYellowConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:dark_yellow_concrete_powder")
	public static final Block block = null;
	public DarkYellowConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 31);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_yellow_concrete_powder");
		}
