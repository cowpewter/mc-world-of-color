...
public class DarkYellowConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_yellow_concrete_powder")
	public static final Block block = null;
	public DarkYellowConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 31);
	}
