...
public class DarkPurpleStainedGlassPaneBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_purple_stained_glass_pane")
	public static final Block block = null;
	public DarkPurpleStainedGlassPaneBlock(CowpewterWocModElements instance) {
		super(instance, 747);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_purple_stained_glass_pane");
		}
		...
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0.43137254902f, 0.156862745098f, 0.576470588235f};
		}
