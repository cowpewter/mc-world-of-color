...
public class DoublePastelPinkConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_pastel_pink_concrete_powder")
	public static final Block block = null;
	public DoublePastelPinkConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 86);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("double_pastel_pink_concrete_powder");
		}
