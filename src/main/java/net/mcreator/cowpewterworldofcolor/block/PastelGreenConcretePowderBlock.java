...
public class PastelGreenConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:pastel_green_concrete_powder")
	public static final Block block = null;
	public PastelGreenConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 101);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("pastel_green_concrete_powder");
		}
