...
public class PastelGreenConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_green_concrete_powder")
	public static final Block block = null;
	public PastelGreenConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 101);
	}
