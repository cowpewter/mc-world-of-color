...
public class LightestMagentaWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_magenta_wool")
	public static final Block block = null;
	public LightestMagentaWoolBlock(CowpewterWocModElements instance) {
		super(instance, 641);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightest_magenta_wool");
		}
