...
public class DarkestMagentaConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_magenta_concrete_powder")
	public static final Block block = null;
	public DarkestMagentaConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 156);
	}
