...
public class DarkPinkConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_pink_concrete_powder")
	public static final Block block = null;
	public DarkPinkConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 23);
	}
