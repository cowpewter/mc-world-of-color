...
public class DarkPinkConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:dark_pink_concrete_powder")
	public static final Block block = null;
	public DarkPinkConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 23);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_pink_concrete_powder");
		}
