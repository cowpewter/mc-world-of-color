...
public class PastelOrangeConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:pastel_orange_concrete")
	public static final Block block = null;
	public PastelOrangeConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 112);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pastel_orange_concrete");
		}
