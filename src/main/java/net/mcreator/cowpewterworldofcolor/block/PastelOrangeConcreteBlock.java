...
public class PastelOrangeConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_orange_concrete")
	public static final Block block = null;
	public PastelOrangeConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 112);
	}
