...
public class PastelBlackWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_black_wool")
	public static final Block block = null;
	public PastelBlackWoolBlock(CowpewterWocModElements instance) {
		super(instance, 603);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pastel_black_wool");
		}
