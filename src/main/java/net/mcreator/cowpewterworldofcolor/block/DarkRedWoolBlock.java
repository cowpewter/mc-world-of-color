...
public class DarkRedWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_red_wool")
	public static final Block block = null;
	public DarkRedWoolBlock(CowpewterWocModElements instance) {
		super(instance, 654);
	}
