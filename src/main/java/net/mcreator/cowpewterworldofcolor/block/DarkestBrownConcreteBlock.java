...
public class DarkestBrownConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:darkest_brown_concrete")
	public static final Block block = null;
	public DarkestBrownConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 141);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkest_brown_concrete");
		}
