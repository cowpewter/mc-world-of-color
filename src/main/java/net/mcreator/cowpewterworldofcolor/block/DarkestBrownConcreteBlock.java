...
public class DarkestBrownConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_brown_concrete")
	public static final Block block = null;
	public DarkestBrownConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 141);
	}
