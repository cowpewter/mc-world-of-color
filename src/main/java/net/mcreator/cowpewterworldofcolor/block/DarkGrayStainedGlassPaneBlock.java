...
public class DarkGrayStainedGlassPaneBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_gray_stained_glass_pane")
	public static final Block block = null;
	public DarkGrayStainedGlassPaneBlock(CowpewterWocModElements instance) {
		super(instance, 731);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_gray_stained_glass_pane");
		}
		...
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0.223529411765f, 0.247058823529f, 0.258823529412f};
		}
