...
public class PastelBrownConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_brown_concrete")
	public static final Block block = null;
	public PastelBrownConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 96);
	}
