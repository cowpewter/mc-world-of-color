...
public class PastelBrownConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:pastel_brown_concrete")
	public static final Block block = null;
	public PastelBrownConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 96);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pastel_brown_concrete");
		}
