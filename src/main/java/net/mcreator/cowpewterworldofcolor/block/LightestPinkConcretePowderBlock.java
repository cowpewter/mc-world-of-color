...
public class LightestPinkConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_pink_concrete_powder")
	public static final Block block = null;
	public LightestPinkConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 192);
	}
