...
public class LightestPinkConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:lightest_pink_concrete_powder")
	public static final Block block = null;
	public LightestPinkConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 192);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("lightest_pink_concrete_powder");
		}
