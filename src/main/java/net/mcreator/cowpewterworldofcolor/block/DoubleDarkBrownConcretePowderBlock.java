...
public class DoubleDarkBrownConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_dark_brown_concrete_powder")
	public static final Block block = null;
	public DoubleDarkBrownConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 35);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("double_dark_brown_concrete_powder");
		}
