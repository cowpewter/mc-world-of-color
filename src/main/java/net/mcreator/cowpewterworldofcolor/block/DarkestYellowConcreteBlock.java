...
public class DarkestYellowConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:darkest_yellow_concrete")
	public static final Block block = null;
	public DarkestYellowConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 167);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkest_yellow_concrete");
		}
