...
public class DarkestYellowConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_yellow_concrete")
	public static final Block block = null;
	public DarkestYellowConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 167);
	}
