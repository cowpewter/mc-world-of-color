...
public class DarkCyanWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_cyan_wool")
	public static final Block block = null;
	public DarkCyanWoolBlock(CowpewterWocModElements instance) {
		super(instance, 612);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_cyan_wool");
		}
