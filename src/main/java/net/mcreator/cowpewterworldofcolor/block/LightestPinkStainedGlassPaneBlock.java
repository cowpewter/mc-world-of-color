...
public class LightestPinkStainedGlassPaneBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_pink_stained_glass_pane")
	public static final Block block = null;
	public LightestPinkStainedGlassPaneBlock(CowpewterWocModElements instance) {
		super(instance, 807);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("lightest_pink_stained_glass_pane");
		}
		...
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0.972549019608f, 0.725490196078f, 0.8f};
		}
