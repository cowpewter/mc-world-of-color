...
public class LightestYellowWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_yellow_wool")
	public static final Block block = null;
	public LightestYellowWoolBlock(CowpewterWocModElements instance) {
		super(instance, 663);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightest_yellow_wool");
		}
