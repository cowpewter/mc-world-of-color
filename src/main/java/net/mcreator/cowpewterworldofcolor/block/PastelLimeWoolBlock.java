...
public class PastelLimeWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_lime_wool")
	public static final Block block = null;
	public PastelLimeWoolBlock(CowpewterWocModElements instance) {
		super(instance, 636);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pastel_lime_wool");
		}
