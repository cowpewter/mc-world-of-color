...
public class LightestGrayWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_gray_wool")
	public static final Block block = null;
	public LightestGrayWoolBlock(CowpewterWocModElements instance) {
		super(instance, 621);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightest_gray_wool");
		}
