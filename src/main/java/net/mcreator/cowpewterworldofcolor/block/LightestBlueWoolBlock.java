...
public class LightestBlueWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_blue_wool")
	public static final Block block = null;
	public LightestBlueWoolBlock(CowpewterWocModElements instance) {
		super(instance, 607);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightest_blue_wool");
		}
