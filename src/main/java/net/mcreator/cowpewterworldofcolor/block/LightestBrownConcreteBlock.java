...
public class LightestBrownConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:lightest_brown_concrete")
	public static final Block block = null;
	public LightestBrownConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 173);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightest_brown_concrete");
		}
