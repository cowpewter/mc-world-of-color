...
public class DoubleDarkYellowConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_dark_yellow_concrete")
	public static final Block block = null;
	public DoubleDarkYellowConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 62);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("double_dark_yellow_concrete");
		}
