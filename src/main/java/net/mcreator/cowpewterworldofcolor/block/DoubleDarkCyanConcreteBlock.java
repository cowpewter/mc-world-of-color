...
public class DoubleDarkCyanConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_dark_cyan_concrete")
	public static final Block block = null;
	public DoubleDarkCyanConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 38);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("double_dark_cyan_concrete");
		}
