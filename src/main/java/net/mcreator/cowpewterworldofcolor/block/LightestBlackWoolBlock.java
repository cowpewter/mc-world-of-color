...
public class LightestBlackWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_black_wool")
	public static final Block block = null;
	public LightestBlackWoolBlock(CowpewterWocModElements instance) {
		super(instance, 602);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightest_black_wool");
		}
