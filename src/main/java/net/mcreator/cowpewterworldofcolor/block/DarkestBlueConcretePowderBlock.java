...
public class DarkestBlueConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:darkest_blue_concrete_powder")
	public static final Block block = null;
	public DarkestBlueConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 140);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("darkest_blue_concrete_powder");
		}
