...
public class DarkestBlueConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_blue_concrete_powder")
	public static final Block block = null;
	public DarkestBlueConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 140);
	}
