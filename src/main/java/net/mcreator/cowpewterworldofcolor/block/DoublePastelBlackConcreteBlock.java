...
public class DoublePastelBlackConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_pastel_black_concrete")
	public static final Block block = null;
	public DoublePastelBlackConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 64);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("double_pastel_black_concrete");
		}
