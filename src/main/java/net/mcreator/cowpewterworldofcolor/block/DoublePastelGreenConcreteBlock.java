...
public class DoublePastelGreenConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_pastel_green_concrete")
	public static final Block block = null;
	public DoublePastelGreenConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 74);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("double_pastel_green_concrete");
		}
