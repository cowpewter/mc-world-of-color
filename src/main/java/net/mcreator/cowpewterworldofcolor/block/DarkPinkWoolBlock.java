...
public class DarkPinkWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_pink_wool")
	public static final Block block = null;
	public DarkPinkWoolBlock(CowpewterWocModElements instance) {
		super(instance, 646);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_pink_wool");
		}
