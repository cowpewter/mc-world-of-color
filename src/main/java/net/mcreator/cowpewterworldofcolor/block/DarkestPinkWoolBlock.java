...
public class DarkestPinkWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_pink_wool")
	public static final Block block = null;
	public DarkestPinkWoolBlock(CowpewterWocModElements instance) {
		super(instance, 647);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkest_pink_wool");
		}
