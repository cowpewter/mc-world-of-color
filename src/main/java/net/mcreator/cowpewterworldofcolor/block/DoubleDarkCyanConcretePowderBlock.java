...
public class DoubleDarkCyanConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_dark_cyan_concrete_powder")
	public static final Block block = null;
	public DoubleDarkCyanConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 37);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("double_dark_cyan_concrete_powder");
		}
