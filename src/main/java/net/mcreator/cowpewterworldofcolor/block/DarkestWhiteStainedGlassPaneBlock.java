...
public class DarkestWhiteStainedGlassPaneBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_white_stained_glass_pane")
	public static final Block block = null;
	public DarkestWhiteStainedGlassPaneBlock(CowpewterWocModElements instance) {
		super(instance, 781);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("darkest_white_stained_glass_pane");
		}
		...
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0.58431372549f, 0.6f, 0.596078431373f};
		}
