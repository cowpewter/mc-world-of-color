...
public class PastelBlueConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:pastel_blue_concrete_powder")
	public static final Block block = null;
	public PastelBlueConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 93);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("pastel_blue_concrete_powder");
		}
