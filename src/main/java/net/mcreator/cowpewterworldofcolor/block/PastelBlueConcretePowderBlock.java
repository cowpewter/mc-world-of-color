...
public class PastelBlueConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_blue_concrete_powder")
	public static final Block block = null;
	public PastelBlueConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 93);
	}
