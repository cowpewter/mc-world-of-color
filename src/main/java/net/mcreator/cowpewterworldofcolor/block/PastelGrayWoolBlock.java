...
public class PastelGrayWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_gray_wool")
	public static final Block block = null;
	public PastelGrayWoolBlock(CowpewterWocModElements instance) {
		super(instance, 620);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pastel_gray_wool");
		}
