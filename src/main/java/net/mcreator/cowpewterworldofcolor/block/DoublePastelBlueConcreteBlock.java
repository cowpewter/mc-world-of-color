...
public class DoublePastelBlueConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_pastel_blue_concrete")
	public static final Block block = null;
	public DoublePastelBlueConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 66);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("double_pastel_blue_concrete");
		}
