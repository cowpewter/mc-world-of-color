...
public class DarkestBlueConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_blue_concrete")
	public static final Block block = null;
	public DarkestBlueConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 139);
	}
