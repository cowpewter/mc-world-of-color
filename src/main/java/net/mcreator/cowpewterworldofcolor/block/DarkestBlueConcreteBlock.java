...
public class DarkestBlueConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:darkest_blue_concrete")
	public static final Block block = null;
	public DarkestBlueConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 139);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkest_blue_concrete");
		}
