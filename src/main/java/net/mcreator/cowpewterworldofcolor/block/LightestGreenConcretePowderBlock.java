...
public class LightestGreenConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_green_concrete_powder")
	public static final Block block = null;
	public LightestGreenConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 180);
	}
