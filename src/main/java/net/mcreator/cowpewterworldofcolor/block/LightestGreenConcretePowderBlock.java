...
public class LightestGreenConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:lightest_green_concrete_powder")
	public static final Block block = null;
	public LightestGreenConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 180);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("lightest_green_concrete_powder");
		}
