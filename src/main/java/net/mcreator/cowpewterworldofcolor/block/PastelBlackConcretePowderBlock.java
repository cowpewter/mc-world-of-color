...
public class PastelBlackConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_black_concrete_powder")
	public static final Block block = null;
	public PastelBlackConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 1);
	}
