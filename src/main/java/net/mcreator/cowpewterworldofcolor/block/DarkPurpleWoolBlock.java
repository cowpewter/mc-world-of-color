...
public class DarkPurpleWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_purple_wool")
	public static final Block block = null;
	public DarkPurpleWoolBlock(CowpewterWocModElements instance) {
		super(instance, 650);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_purple_wool");
		}
