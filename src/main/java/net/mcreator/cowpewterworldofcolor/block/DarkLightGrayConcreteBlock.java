...
public class DarkLightGrayConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_light_gray_concrete")
	public static final Block block = null;
	public DarkLightGrayConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 16);
	}
