...
public class DarkLightGrayConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:dark_light_gray_concrete")
	public static final Block block = null;
	public DarkLightGrayConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 16);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_light_gray_concrete");
		}
