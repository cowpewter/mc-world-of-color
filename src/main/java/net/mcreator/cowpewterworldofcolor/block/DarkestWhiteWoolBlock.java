...
public class DarkestWhiteWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_white_wool")
	public static final Block block = null;
	public DarkestWhiteWoolBlock(CowpewterWocModElements instance) {
		super(instance, 659);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkest_white_wool");
		}
