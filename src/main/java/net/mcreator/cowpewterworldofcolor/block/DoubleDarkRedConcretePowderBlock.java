...
public class DoubleDarkRedConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_dark_red_concrete_powder")
	public static final Block block = null;
	public DoubleDarkRedConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 57);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("double_dark_red_concrete_powder");
		}
