...
public class DarkestRedStainedGlassPaneBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_red_stained_glass_pane")
	public static final Block block = null;
	public DarkestRedStainedGlassPaneBlock(CowpewterWocModElements instance) {
		super(instance, 779);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("darkest_red_stained_glass_pane");
		}
		...
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0.41568627451f, 0.109803921569f, 0.090196078431f};
		}
