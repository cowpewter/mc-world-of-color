...
public class DarkestBrownConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_brown_concrete_powder")
	public static final Block block = null;
	public DarkestBrownConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 142);
	}
