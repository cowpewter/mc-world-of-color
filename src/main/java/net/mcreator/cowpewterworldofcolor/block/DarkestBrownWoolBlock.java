...
public class DarkestBrownWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_brown_wool")
	public static final Block block = null;
	public DarkestBrownWoolBlock(CowpewterWocModElements instance) {
		super(instance, 609);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkest_brown_wool");
		}
