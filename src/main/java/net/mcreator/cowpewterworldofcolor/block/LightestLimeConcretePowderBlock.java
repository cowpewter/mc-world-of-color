...
public class LightestLimeConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:lightest_lime_concrete_powder")
	public static final Block block = null;
	public LightestLimeConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 186);
	}
