...
public class DoubleDarkGreenConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_dark_green_concrete")
	public static final Block block = null;
	public DoubleDarkGreenConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 42);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("double_dark_green_concrete");
		}
