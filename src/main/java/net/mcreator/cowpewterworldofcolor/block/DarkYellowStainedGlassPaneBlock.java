...
public class DarkYellowStainedGlassPaneBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_yellow_stained_glass_pane")
	public static final Block block = null;
	public DarkYellowStainedGlassPaneBlock(CowpewterWocModElements instance) {
		super(instance, 753);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_yellow_stained_glass_pane");
		}
		...
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0.796078431373f, 0.674509803922f, 0.192156862745f};
		}
