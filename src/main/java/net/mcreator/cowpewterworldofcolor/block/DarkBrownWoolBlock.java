...
public class DarkBrownWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_brown_wool")
	public static final Block block = null;
	public DarkBrownWoolBlock(CowpewterWocModElements instance) {
		super(instance, 608);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_brown_wool");
		}
