...
public class PastelRedStainedGlassPaneBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_red_stained_glass_pane")
	public static final Block block = null;
	public PastelRedStainedGlassPaneBlock(CowpewterWocModElements instance) {
		super(instance, 841);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("pastel_red_stained_glass_pane");
		}
		...
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0.752941176471f, 0.345098039216f, 0.317647058824f};
		}
