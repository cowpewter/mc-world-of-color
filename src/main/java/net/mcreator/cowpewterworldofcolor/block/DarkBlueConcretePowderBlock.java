...
public class DarkBlueConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_blue_concrete_powder")
	public static final Block block = null;
	public DarkBlueConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 3);
	}
