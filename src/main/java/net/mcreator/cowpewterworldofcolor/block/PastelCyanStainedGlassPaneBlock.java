...
public class PastelCyanStainedGlassPaneBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_cyan_stained_glass_pane")
	public static final Block block = null;
	public PastelCyanStainedGlassPaneBlock(CowpewterWocModElements instance) {
		super(instance, 821);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("pastel_cyan_stained_glass_pane");
		}
		...
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0.270588235294f, 0.690196078431f, 0.690196078431f};
		}
