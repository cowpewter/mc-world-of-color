...
public class DarkYellowConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:dark_yellow_concrete")
	public static final Block block = null;
	public DarkYellowConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 32);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_yellow_concrete");
		}
