...
public class DarkYellowConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_yellow_concrete")
	public static final Block block = null;
	public DarkYellowConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 32);
	}
