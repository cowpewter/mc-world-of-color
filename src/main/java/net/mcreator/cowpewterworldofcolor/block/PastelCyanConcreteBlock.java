...
public class PastelCyanConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_cyan_concrete")
	public static final Block block = null;
	public PastelCyanConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 98);
	}
