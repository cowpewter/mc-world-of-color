...
public class PastelCyanConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:pastel_cyan_concrete")
	public static final Block block = null;
	public PastelCyanConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 98);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pastel_cyan_concrete");
		}
