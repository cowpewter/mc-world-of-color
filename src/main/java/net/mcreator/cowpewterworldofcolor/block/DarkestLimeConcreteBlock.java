...
public class DarkestLimeConcreteBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:darkest_lime_concrete")
	public static final Block block = null;
	public DarkestLimeConcreteBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 153);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkest_lime_concrete");
		}
