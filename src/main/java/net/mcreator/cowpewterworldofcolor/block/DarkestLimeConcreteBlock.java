...
public class DarkestLimeConcreteBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:darkest_lime_concrete")
	public static final Block block = null;
	public DarkestLimeConcreteBlock(CowpewterWocModElements instance) {
		super(instance, 153);
	}
