...
public class DoubleDarkWhiteConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:double_dark_white_concrete_powder")
	public static final Block block = null;
	public DoubleDarkWhiteConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 59);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("double_dark_white_concrete_powder");
		}
