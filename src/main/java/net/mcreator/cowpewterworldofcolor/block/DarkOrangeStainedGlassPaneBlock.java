...
public class DarkOrangeStainedGlassPaneBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_orange_stained_glass_pane")
	public static final Block block = null;
	public DarkOrangeStainedGlassPaneBlock(CowpewterWocModElements instance) {
		super(instance, 743);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_orange_stained_glass_pane");
		}
		...
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0.780392156863f, 0.396078431373f, 0.090196078431f};
		}
