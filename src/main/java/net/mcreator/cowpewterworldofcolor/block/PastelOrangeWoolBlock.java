...
public class PastelOrangeWoolBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:pastel_orange_wool")
	public static final Block block = null;
	public PastelOrangeWoolBlock(CowpewterWocModElements instance) {
		super(instance, 644);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pastel_orange_wool");
		}
