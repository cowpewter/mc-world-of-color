...
public class DarkMagentaConcretePowderBlock extends CowpewterWorldOfColorModElements.ModElement {
	@ObjectHolder("cowpewter_world_of_color:dark_magenta_concrete_powder")
	public static final Block block = null;
	public DarkMagentaConcretePowderBlock(CowpewterWorldOfColorModElements instance) {
		super(instance, 19);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_magenta_concrete_powder");
		}
