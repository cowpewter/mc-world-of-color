...
public class DarkMagentaConcretePowderBlock extends CowpewterWocModElements.ModElement {
	@ObjectHolder("cowpewter_woc:dark_magenta_concrete_powder")
	public static final Block block = null;
	public DarkMagentaConcretePowderBlock(CowpewterWocModElements instance) {
		super(instance, 19);
	}
